                ...
                <div class="col-md-5 text-center">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <img class="img-responsive" src="<?php echo $photos[0]->getMedURL();?>">
                        </div>
                    </div>
                    <!--End Image of Pet-->
                        ...
                        <div class="panel-body">
                            <?php 
                                for ($i=0; $i<sizeof($photos); $i++) {
                                    $photo = $photos[$i]->getSmallURL();
                                    echo "<div class='col-sm-3 text-center'>";
                                    echo "  <a href=''><img class='img-responsive' src='$photo'></a>";
                                    echo "</div>";
                                }
                            ?>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-sm-7">
                                ...
                                <p class="col-xs-8 text-left"><?php echo $listing->species;?></p>
                                <p class="col-xs-4 text-left"><strong>Breed:</strong></p>
                                <p class="col-xs-8 text-left"><?php echo $listing->breed;?></p>
                                <p class="col-xs-4 text-left"><strong>Sex:</strong></p>
                                <p class="col-xs-8 text-left"><?php echo $listing->sex;?></p>
                                <p class="col-xs-4 text-left"><strong>Age:</strong></p>
                                <p class="col-xs-8 text-left"><?php echo $listing->age;?></p>
                            </div>
                            <!--End Basic Info-->
                            
                            <!--Adopt + Favorite-->
                            <div class="col-sm-5">
                                <a href="adoption-request-form.php">
                            ...
                            <div class="col-sm-12">
                                ...
                                <p><?php
                                    $traits = $listing->getPersonalityTraits();
